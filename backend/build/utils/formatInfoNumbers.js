...
exports.getFirstThreeNonZeroDecimals = (value) => {
 ...
 */
exports.formatAmount = (amount, options) => {
    ...
    if (amount < 1 && !tokenPrecision) {
        return exports.getFirstThreeNonZeroDecimals(amount);
    }
    let precision = 2;
    if (tokenPrecision) {
    ...
    return numeral_1.default(amountWithPrecision).format(format).toUpperCase();
};
