...
const blocksQueryConstructor = (subqueries) => {
    return graphql_request_1.gql `query blocks {
    ${subqueries}
  }`;
};
/**
 ...
 */
exports.getBlocksFromTimestamps = (timestamps, sortDirection = 'desc', skipCount = 500) => __awaiter(void 0, void 0, void 0, function* () {
    if ((timestamps === null || timestamps === void 0 ? void 0 : timestamps.length) === 0) {
        return [];
    }
    const fetchedData = yield infoQueryHelpers_1.multiQuery(blocksQueryConstructor, getBlockSubqueries(timestamps), endpoints_1.BLOCKS_CLIENT, skipCount);
 ...
 * @param timestamps
 */
exports.useBlocksFromTimestamps = (timestamps, sortDirection = 'desc', skipCount = 1000) => {
    const [blocks, setBlocks] = react_1.useState();
    const [error, setError] = react_1.useState(false);
    react_1.useEffect(() => {
        const fetchData = () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield exports.getBlocksFromTimestamps(timestamps, sortDirection, skipCount);
            if (result.length === 0) {
                setError(true);
            }
            else {
